...
class Controller {
    ...
    public:
         ...
         * throws: invalid_arument if the arguments are invalid or if a Movie with the same id already exists in the repo
         */
        void database_add(const std::string& title, const std::string& genre, int year, int likes, const std::string& trailer);
        /*
         ...
         */
        void database_update(const std::string& id, const std::string& title, const std::string& genre, int year, int likes, const std::string& trailer);
