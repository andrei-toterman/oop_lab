...
class Controller {
    ...
    /*
     * creates a new Movie with the given arguments and adds it to the databasae if it is valid
     * throws: invalid_arument if the arguments are invalid or if a Movie with the same id already
     * exists in the repo
     */
     ...
     * throws: invalid_arument if a Movie with the same id already exists in the watchlist
     */
