...
class Movie {
    ...
    /*
     * extraction operator for ostream; performs a formatted output to the
     * ostream input: an ostream reference and a Movie reference output:
     * reference to the same ostream
     */
